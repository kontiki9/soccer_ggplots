...
To save space I don't show the data frames with the coordinate points and labelling data, however you can find them [here](https://github.com/Ryo-N7/soccer_ggplots) on the GitHub repo!
...
```{r Osako winner data, echo=FALSE, warning=FALSE, message=FALSE}
...
For Osako's goal, here's a preview of the `tweenr` version. Much easier as I made it so that the only moving bit to interpolate was the path of the ball.
