...
kobe_minutes %>% 
  ...
  labs(
    x = "Current Age (As of March 9, 2019)", y = "% of Minutes Played", 
...
tokyo_minutes %>% 
  ...
  labs(
    x = "Current Age (As of March 9, 2019)", y = "% of Minutes Played", 
    title = "FC Tokyo: Age-Utility Matrix",
    subtitle = "J-League 2018 Season",
    caption = "Data from transfermarkt.com\nBy @R_by_Ryo") +
  theme_bw() +
  theme(
    text = element_text(family = "Roboto Condensed"),
    panel.grid.minor.y = element_blank(),
    panel.border = element_rect(color = "#271672"),
    plot.title = element_text(color = "#271672"),
    plot.subtitle = element_text(color = "#DD2220"))
```
...
shonan_minutes <- results_comb %>% 
  ...
  mutate(age = as.numeric(age),
         minutes = minutes %>% 
           ...
           str_replace("'", "") %>% 
           as.numeric(),
         min_perc = (minutes / 270) %>% round(digits = 3)) %>% 
...
shonan_minutes %>% 
  ...
  labs(
    x = "Current Age (As of March 9, 2019)", y = "% of Minutes Played", 
    title = "Shonan Bellmare: Age-Utility Matrix",
    subtitle = "J-League 2019 Season (3 Games So Far: 100% = 270 minutes)",
    caption = "Data from transfermarkt.com\nBy @R_by_Ryo") +
  theme_bw() +
  theme(
    text = element_text(family = "Roboto Condensed"),
    panel.grid.minor.y = element_blank(),
    panel.border = element_rect(color = "#67B356"),
    plot.title = element_text(color = "#67B356"),
    plot.subtitle = element_text(color = "#103C95")) -> shonan_plot
```
