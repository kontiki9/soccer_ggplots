...
kobe_minutes %>% 
  ...
  labs(
    ...
    subtitle = "J-League 2018 Season (34 試合: 100% = 3420分)",
    caption = "Data from transfermarkt.com\nBy @R_by_Ryo") +
  theme_bw() +
  theme(
    text = element_text(family = "Roboto Condensed"),
    panel.grid.minor.y = element_blank(),
    plot.title = element_text(color = "darkred", size = 16),
...
tokyo_minutes %>% 
  ...
  theme(
    ...
    plot.title = element_text(color = "#271672", size = 16),
...
shonan_minutes %>% 
  ...
  theme(
    ...
    plot.title = element_text(color = "#67B356", size = 16),
