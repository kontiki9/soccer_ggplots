...
ac_top_graph <- ac_top_scorers %>% 
  ...
  labs(title = "Top Scorers of the Asian Cup!",
       subtitle = "Most goals in a single tournament is 8 by Ali Daei in 1996.",
...
ac_goals_df %>% 
  ...
  scale_y_continuous(limit = c(NA, 5.5)) +
  labs(x = NULL, y = "Goals per Game",
       title = "Goals per Game throughout the Asian Cup.",
       subtitle = "Odd dip throughout the 80s to early 90s...") +
  theme_minimal() +
  theme() +
  annotate(geom = "text", x = "'56", y = 5.5, 
           label = "Total Number of Games Played", hjust = 0) +
  annotate(geom = "text", x = "'60", y = 5.2, label = "6") +
  annotate(geom = "segment", x = 1, xend = 3, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = "'68", y = 5.2, label = "10") +
  annotate(geom = "segment", x = 3.8, xend = 4.2, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = "'72", y = 5.2, label = "13") +
  annotate(geom = "segment", x = 4.8, xend = 5.2, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = "'76", y = 5.2, label = "10") +
  annotate(geom = "segment", x = 5.8, xend = 6.2, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = "'84", y = 5.2, label = "24") +
  annotate(geom = "segment", x = 7, xend = 9, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = "'92", y = 5.2, label = "16") +
  annotate(geom = "segment", x = 9.8, xend = 10.2, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = 11.5, y = 5.2, label = "26") +
  annotate(geom = "segment", x = 11, xend = 12, y = 5.1, yend = 5.1) +
  annotate(geom = "text", x = 14.5, y = 5.2, label = "32") +
  annotate(geom = "segment", x = 13, xend = 16, y = 5.1, yend = 5.1)
