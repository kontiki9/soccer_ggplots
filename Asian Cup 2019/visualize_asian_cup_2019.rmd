...
Now we make a line graph but with LOTS of `annotate()` code! 
...
I wanted to try to make this look a bit more "official" so I attempted to add the Asian Cup logo on the top right corner. There probably are alternative ways to how I did it below, especially by using grobs but I was reminded of [this]() blog post by Daniel Hadley who used the `magick` package to add a footer with a logo onto a ggplot object. 

I've used magick before for animations but this was a good chance to try it out for image editing.
...
Ultimately, I couldn't find much information on why those tournaments in the 80s in particular were such low scoring affairs. I wasn't alive to watch those games on TV nor could I have any illuminating articles or blog posts on the style of Asian football back in the 80s 
...
while Austalia is a very different team without Aaaron Mooy as shown in their abject loss to Jordan in their opening match.
